# Emotion Adaptive Learning — ONE COMMAND START

ONE COMMAND START

To launch the full system run from the project root:

powershell -ExecutionPolicy Bypass -File run_project.ps1

This script will create a venv, install backend and frontend deps, start the backend on port 8000 and frontend on port 3000 and open your browser.
